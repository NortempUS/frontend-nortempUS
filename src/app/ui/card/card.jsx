...
export default function Card() {
  return (
    <div className='relative flex items-center w-full h-48 flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md'>
      <img
      ...
      <div className='p-3'>
        ...
        <p className='mb-1 md:block hidden overflow-clip font-sans text-base font-normal leading-relaxed text-gray-700 antialiased'>
